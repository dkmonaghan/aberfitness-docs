...
\par
As REST endpoints were used as the primary message exchange method, we could send and request JSON payloads to ensure the system behaved as expected. Multiple third party solutions were used for testing APIs, such as the \textit{Insomnia REST Client}\cite{insomnia}. %TODO add reference here
